...
$.ajax({
        ...
        success: function(response) {
            $('#course').html("");
            $('#course').append(new Option("--select--", "", true, false));
            $.each(response, function (index, topic) {
                $('#course').append(new Option(topic.course, topic.id, false, false));
            });
        }
    });
}
...
$.ajax({
        ...
        dataType: "json",
        success: function(response) {
            $('#place').append(new Option("--select--", "", true, false));
            $.each(response, function (index, topic) {
                $('#place').append(new Option(topic.place, topic.id, false, false));
            });
        }
    });
}
...
$.ajax({
        ...
        dataType: "json",
        success: function(response) {
            $('#point').append(new Option("--select--", "", true, false));
            $.each(response, function (index, topic) {
                $('#point').append(new Option(topic.point, topic.id, false, false));
            });
        }
    });
}
...
function fillYears() {
    var i;
    $('#birth-year').append(new Option("-????-", "", true, false));
    for (i= (new Date()).getFullYear(); i >= 1940; i-- ) {
        $('#birth-year').append(new Option(i, i, false, false));
    };
}
...
function fillDays() {
    ...
    $('#birth-day')
        ...
        .end();
    var i;
    $('#birth-day').append(new Option ("-??-", "", true, false));
    for (i=1; i <= numberOfDays; i++) {
        $('#birth-day').append(new Option (i, i, false, false));
    }
